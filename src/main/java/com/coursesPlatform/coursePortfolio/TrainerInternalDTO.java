...
public class TrainerInternalDTO {
    ...
    public TrainerInternalDTO(String name, String lastName, String mail, String phoneNumber, String biography) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        TrainerInternalDTO that = (TrainerInternalDTO) o;
